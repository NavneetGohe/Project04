...
<body>
	...
	<table>
	<font color="black"><table>Submit your Email Address and we will Send You password</table><br><br>
...
<table>	
	...
	<input type="submit" name="operation" value="<%=ForgetPasswordCtl.OP_GO %>"style="padding: 3px;">
