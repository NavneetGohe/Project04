		...
		<center>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="firstName" size="42" class="p2"
				...
				<tr>
					...
					<td><input type="text" name="lastName" size="42" class="p2"
				...
				<tr>
					...
					<td><input type="password" name="password" size="42"
				...
				<tr>
					...
					<td><input type="password" name="confirmPassword" class="p2"
						size="42" placeholder="Enter Confirm password"
						value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="mobile" size="42" 
				...
				<tr>
					...
					<td><input type="text" readonly="readonly"  name="dob" id="datepicker" class="p2"
						size="42" placeholder="Enter Date of Birth"
