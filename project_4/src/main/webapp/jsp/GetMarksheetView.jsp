...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table border=1>
				<tr>
					<th><b> RollNo <span style="color:red;">*</span></b></th>&emsp;
					<td><input type="text" name="rollNo" size="40" class="p2"
						placeholder="Enter RollNo"
						value="<%=ServletUtility.getParameter("rollNo", request)%>">&emsp;

						<input type="submit" name="operation"
						value="<%=GetMarksheetCtl.OP_GO%>" size="40" class="p2"> &nbsp;<input type="submit" name="operation"
						value="<%=GetMarksheetCtl.OP_RESET%>" size="40" class="p2"">
						<font color="red" class="p3" style="position: fixed;"><%=ServletUtility.getErrorMessage("rollNo", request)%></font>
					<td>
						<%
			...
			<table border="1" width="60%">
				...
				<tr>
					...
					<td id="po1" align="center" colspan="3"><%=DataUtility.getStringData(bean.getRollNo())%></td>

				</tr>
				<tr>
					<th id="po1" colspan="2">Name</th>
					<td id="po1" align="center" colspan="3"><%=DataUtility.getStringData(bean.getName())%></td>
				</tr>
				<tr>
