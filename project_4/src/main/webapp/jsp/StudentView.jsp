		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="email" size="42" class="p2"
				...
				<tr>
					...
					<td><input type="text" name="mobileNo" size="42" class="p2"
		  ...
		  <td style="position:fixed;"><font color="red"><%=ServletUtility.getErrorMessage("CollegeId",request) %></font>
				...
				<tr>
					<th align="left" class="p1">DateOfBirth<span
						style="color: red;">*</span></th>
					<td><input type="text" readonly="readonly" name="dob"
						id="datepicker" class="p2" size="42"
				...
				<tr>
					...
					<td colspan="2" align="center"><input type="submit"
						...
						type="submit" style="padding: 4px;" name="operation"
