...
//			long pk=9L;
			...
			CollegeBean deletedBean=model.findByPK(13);
	...
	public static void testUpdate(){
		try{
			CollegeBean bean=model.findByPK(12L);
			...
			if(!"Acropolish".equals(updateBean.getName())){
	...
	public static void testFindByName() {
		try{
			CollegeBean bean=model.findByName("Aurbindo");
			if(bean==null){
