...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(login)) {
			...
			request.setAttribute("login", PropertyReader.getValue("Please enter correct Login Id"));
			pass = false;
		...
		if (DataValidator.isNull(dob)) {
			...
			request.setAttribute("dob", PropertyReader.getValue("dob", "Age Must be greater then 18 year"));
			pass = false;
		...
		if (!request.getParameter("password").equals(request.getParameter("confirmPassword"))
			...
			request.setAttribute("confirmPassword", "Confirm password not matched");
			pass = false;
