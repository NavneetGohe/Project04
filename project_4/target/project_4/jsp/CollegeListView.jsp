			...
			<table>
				<tr>
					...
					<%= HTMLUtility.getList("name" , String.valueOf(bean.getId()), list1) %>&emsp;
						...
						<label class="p1">City</label> <input type="text" name="city" class="p2" placeholder="Enter city"
						value="<%=ServletUtility.getParameter("city", request)%>">&emsp;&emsp;
						
						<label class="p1">State</label> <input type="text" name="state" class="p2" placeholder="Enter State"
