...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="POST">
			...
			<table>
				<tr>
					<td><label class="p1">First Name</label>&emsp;<input
						type="text" name="firstName" class="p2" size="42" placeholder="Enter first name"
						value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;

						<label class="p1">Email_Id</label>&emsp;&emsp;<input type="text"
						class="p2" size="42" name="login" placeholder="Enter Email id"
