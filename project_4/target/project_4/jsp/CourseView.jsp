		...
		<center>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="courseName" size="42"
						placeholder="Enter course " class="p2"
				...
				<tr>
					...
					<td><input type="text" name="description" size="42"
						placeholder="Enter description " class="p2"
						value="<%=DataUtility.getStringData(bean.getDescription())%>"></td></td>
