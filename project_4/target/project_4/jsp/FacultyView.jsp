	...
	<table>
		<tr>
		   <th align="left" class="p1">First Name<span style="color: red;">*</span></th>
			  <td><input type="text" name="firstName" class="p2" size="42"
				...
				<tr>
					...
					<td><input type="text" name="lastName" class="p2" size="42"
				...
				<tr>
					...
					<td><input type="text" readonly="readonly" name="joiningDate" class="p2"
						id="datepicker" size="42" placeholder="Enter Joining Date"
				...
				<tr>
					...
					<td><input type="text" name="qualification" class="p2"
						size="42" placeholder="Enter Qualification"
				...
				<tr>
					...
					<td><input type="text" name="mobile"  maxlength="10" size="42" class="p2"
