        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="firstName" size="42"  class="p2" placeholder="please enter name" 
                ...
                <tr>
                    ...
                    <td><input type="text" name="lastName" size="42" class="p2" placeholder="please  enter last name"
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" size="42"  class="p2"
                ...
                <tr>
					...
					<td><input type="text" name="mobile" size="42"  maxlength="10" class="p2" placeholder="please enter mobile no"
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" size="42" class="p2" placeholder="please enter password"
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" size="42" class="p2" placeholder="re-enter password"
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text"  readonly="readonly" name="dob" id="datepicker"  size="42" class="p2"
