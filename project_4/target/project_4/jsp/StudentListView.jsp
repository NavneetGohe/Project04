...
<body>
	...
	<tr>
		<td align="center">
		<label class="p1"> FirstName :</label> <input type="text" name="firstName" class="p2" placeholder="First name"
		value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;&emsp;
						&emsp;&emsp;
		<label class="p1">Email_Id :</label> <input type="text" name="email" class="p2" placeholder="Email id"
