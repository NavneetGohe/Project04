...
<body>
   ...
   <table>
     <tr>
        ...
        <td><input type="text" name="rollNo" size="42px"  class="p2" placeholder="Enter RollNo" 
     ...
     <tr>
       ...
       <tr>
         ...
         <td><input type="text" name="physics" size="42px"  class="p2" placeholder="Enter Marks" 
         ...
         <td><input type="text" name="chemistry" size="42px"  class="p2" placeholder="Enter Marks" 
         ...
         <td><input type="text" name="maths" size="42px"  class="p2" placeholder="Enter Marks" 
